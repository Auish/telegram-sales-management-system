  ...
  <body class="navbar-fixed sidebar-nav fixed-nav">
    <style>
      ...
      body:not(.top-nav) .sidebar .sidebar-nav::-webkit-scrollbar-thumb {
        ...
        /* إضافة حدود بيضاء حول شريط التمرير */
      }
      ...
      .nav-dropdown-items li > a:before {
        content: "\f208";
        position: absolute;
        line-height: 1;
        left: 28px;
        ...
        <form action="" method="post" enctype="multipart/form-data">
          <div class="row">
            <div class="col-lg-12">
              <div class="card">
                <div class="card-header">
                  <i class="fa fa-align-justify"></i> حميع الادوات
                </div>
                <div class="card-block">
                  ...
                  >
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>1</td>
                        <td>الزفاف تراثي قديم</td>
                        <td>ملبوسات الزفاف</td>
                        <td>باليوم</td>
                        <td>14000</td>
                        <td>
                          <img
    ...
    <div id="add-Modal-emplo" class="modal">
      <div class="modal-content">
        <div class="card-header">
          الادوات
          <div class="card-actions">
            <span class="close -model empt">&times;</span>
          </div>
        </div>
        <br />
        <form action="" method="post" enctype="multipart/form-data">
              ...
              <div class="card">
                ...
                <div class="card-block">
                  ...
                  >
                    ...
                    <tbody>
                      <tr>
                        <td><input type="checkbox" class="rowCheckbox2" /></td>
                  ...
                  <div id="selectedRowData2" class="mt-3"></div>
                  <nav>
                    <ul class="pagination">
                      <li class="page-item">
                        <a class="page-link" href="#">Prev</a>
    ...
    <script>
      ...
      var btn = document.getElementById("AddButoon");
    ...
    <script>
      // جافا سكريبت لفتح وغلق المودال
      var modal1 = document.getElementById("add-Modal-emplo");
      var btn1 = document.getElementById("AddButoon-emplo");
      var span1 = document.getElementsByClassName("close -model empt")[0];
    ...
    <script>
      // دالة عامة لإضافة مستمع تحديد الكل
      function addSelectAllListener(
        ...
        if (selectAllCheckbox) {
          selectAllCheckbox.addEventListener("change", function () {
            ...
            displayDataFunction(); // تحديث العرض بناءً على التحديد
          });
        }
      }

      // دالة عامة لإضافة مستمع الأحداث للـ Checkboxes
      function addCheckboxListeners(checkboxClass, displayDataFunction) {
        document.querySelectorAll(`.${checkboxClass}`).forEach((checkbox) => {
          checkbox.addEventListener("change", displayDataFunction);
        });
      }

      // دالة عامة لعرض البيانات المختارة
      function displaySelectedData(tableSelector, checkboxClass, displayDivId) {
        let selectedData = [];
        let rows = document.querySelectorAll(`${tableSelector} tbody tr`);
        rows.forEach((row) => {
          let checkbox = row.querySelector(`.${checkboxClass}`);
        ...
        if (displayDiv) {
          displayDiv.innerHTML = ""; // تفريغ البيانات السابقة
          if (selectedData.length > 0) {
            displayDiv.innerHTML = "<h5>بيانات الأداة:</h5>";
            selectedData.forEach((data) => {
              displayDiv.innerHTML += `
          <div class="form-group row">
            <label for="product_name_${data.username}" class="col-lg-2 col-sm-2 control-label">رقم الأداة</label>
            <div class="col-lg-4">
              <input type="text" name="product_name" class="form-control" id="product_name_${data.username}" value="${data.username}" required>
            </div>
            <label for="product_quantity_${data.username}" class="control-label col-lg-2">الكمية</label>
            <div class="col-lg-4">
              <input type="number" name="product_quantity" class="form-control" id="product_quantity_${data.username}" value="">
            </div>
          </div>`;
            });
          }
      ...
      // تطبيق الدوال على الموديل الأول
      addSelectAllListener("selectAll", "rowCheckbox", function () {
        displaySelectedData("#dataTable", "rowCheckbox", "selectedRowData");
      });
      addCheckboxListeners("rowCheckbox", function () {
        displaySelectedData("#dataTable", "rowCheckbox", "selectedRowData");
      });

      // تطبيق الدوال على الموديل الثاني
      addSelectAllListener("selectAll2", "rowCheckbox2", function () {
        displaySelectedData(
          ".table-striped",
          "rowCheckbox2",
          "selectedRowData2"
      ...
      addCheckboxListeners("rowCheckbox2", function () {
        displaySelectedData(
          ".table-striped",
          "rowCheckbox2",
          "selectedRowData2"
