  ...
  // include("./include/check.php");
    ...
    if(isset($_POST['btn-primary'])) {	
        ...
        if($id > 0) {
            ...
            $admin_pas = $conn->real_escape_string($_POST["admin_pas"]);
            $admin_emil = $conn->real_escape_string($_POST["admin_emil"]);
            
            $sql = "UPDATE user SET username = '$first_name',status = '$gender', email = '$admin_emil', password = '$admin_pas' WHERE id = '$id'";
      ...
      <div class="card">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group row">
              ...
              <div class="col-lg-4">
                <input
                  ...
                  id="first_name"
                  required=""
                  value="<?php echo isset($current_data['username']) ? $current_data['username'] : ''; ?>"
                />
              </div>
              ...
              <div class="col-lg-4">
                <select
                  ...
                  required=""
                >
                  <option value=""><?php echo isset($current_data['status']) ? $current_data['status'] : ''; ?></option>
                  <option value="user">مستحدم</option>
            ...
            <div class="form-group row">
              ...
              <div class="col-lg-4">
                <input
                  ...
                  id="first_name"
                  required=""
                  value="<?php echo isset($current_data['password']) ? $current_data['password'] : ''; ?>"
                />
              </div>
              <label for="LastName" class="col-lg-2 col-sm-2 control-label"
              ...
              <div class="col-lg-4">
                <input
                value="<?php echo isset($current_data['email']) ? $current_data['email'] : ''; ?>"
                  type="email"
                  name="admin_emil"
                  class="form-control"
                  id="last_name"
          ...
          <div class="form-actions">
            <button type="submit" name="btn-primary" class="btn btn-primary">حفظ</button>
