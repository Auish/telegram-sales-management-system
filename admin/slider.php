...
<body class="navbar-fixed sidebar-nav fixed-nav">
    ...
    <div class="sidebar">
     ...
     <div class="card">
        ...
        <form class="form-horizontal" role="form" method="post" action="" enctype="multipart/form-data">
          ...
          <!-- إضاف صوره -->
          <div class="form-group">
              <label for="SliderImage" class="control-label col-md-2">إضافة صورة</label>
        ...
        <div class="col-md-9">
            <div class="fileupload fileupload-new" data-provides="fileupload">
                <div class="fileupload-new thumbnail" style="width: 400px; height: 200px;">
                    <img src="./placeholder.png" alt="" id="div3" style="width: 100%; height: 100%;">
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- حاله الاعلان -->
    <div class="form-group">
        <label for="SliderStatus" class="control-label col-lg-2">حالة الاعلان</label>
        <div class="col-lg-7">
    ...
    <!-- رابط الإعلان -->
    <div class="form-group">
        <label for="ReturnPolicy" class="col-lg-2 col-sm-2 control-label"> الوصف  </label>
        <div class="col-lg-7">
            <textarea name="return_policy" class="form-control" placeholder="Return Policy"></textarea>
        </div>
    </div>
