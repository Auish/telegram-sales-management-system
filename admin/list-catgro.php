        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header">
              <i class="fa fa-align-justify"></i> عرض الفئه
            </div>
...
<?php 
  ...
  while ($row = mysqli_fetch_array($resl)) {
      ...
      <tr>
        ...
        <td>'. $row['price'] .'</td> 
        <td>
            <a href="edit_grop.php?edit_id='. $row['id'] .'">
              <button
                type="submit"
            ...
            <div class="form-group">
              ...
              <div class="col-lg-7">
                <select class="form-control m-bot15" name="category_status">
                  <option value="Active"> حدد النوع</option>
                  <option value="Active">اداة</option>
                  <option value="Inactive"> موظف</option>
                  <option value="Inactive">خدمة</option>
                </select>
              </div>
            </div>
