 ...
 * @license MIT
 ...
 <?php 
  ...
  {	
    $sql = " INSERT INTO groups (date_group,coin,price,month_start,month_end) VALUES ('".$_POST["grop_date"]."','".$_POST["grop_status"]."','".$_POST["grop_pric"]."','".$_POST["month_start"]."','".$_POST["month_end"]."')";
    $saveResult =  $conn->query($sql);
                ...
                if($saveResult > 0)
                {
                  echo '<div class="alert alert-success fade in"> 
                      ...
                      echo "<script>
                      setTimeout(function(){
                          window.location.href = 'list-catgro.php';
...
<body class="navbar-fixed sidebar-nav fixed-nav">
    ...
    <div class="form-group">
        ...
        <div class="col-lg-7">
            <select class="form-control m-bot15" name="month_start" id="month"  >
    ...
    <div class="form-group">
        ...
        <div class="col-lg-7">
        <select class="form-control m-bot15" name="month_end" id="month"  >
                <option value="">اختر الشهر</option>
                <option value="1">1</option>
                <option value="2">2</option>
                <option value="3">3</option>
    ...
    <div class="form-group">
        ...
        <div class="col-lg-7">
            <input class="form-control" name="grop_pric" type="number" step="0.01" min="0" required>
        </div>
    </div>
