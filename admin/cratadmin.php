 <?php 
  ...
  {	
    $sql = " INSERT INTO user (username,email,password ,status) VALUES ('".$_POST["first_name"]."', '".$_POST["admin_emil"]."','".$_POST["admin_pas"]."','".$_POST["gender"]."')";
    ...
    <div class="sidebar">
      <nav class="sidebar-nav open">
        <ul class="nav">
          ...
          <li class="nav-item nav-dropdown">
            <a class="nav-link nav-dropdown-toggle" href="#"><i class="icon-star"></i> طلب بيع</a>
            <ul class="nav-dropdown-items">
              <li class="nav-item">
